...
def get_dirs(fresh=False):
    ...
    home_path = expanduser("~") + '/SDN-Monitoring/'
...
def get_params(directories, fresh=False):
    ...
    if state == "Pulling":
        ...
        if rate_type == "BW":
            ...
            if direction == "Destination":
                params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/BWPullingController.py"
                params['RunParameters']['Datapath'] = "SDM.nodes.BWPullingDatapath.BWPullingDatapath"
            if direction == "Source":
                params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/SrcBWPullingController.py"
        ...
        if rate_type == "Syn":
            ...
            if direction == "Destination":
                params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/SynPullingController.py"
                params['RunParameters']['Datapath'] = "SDM.nodes.SynPullingDatapath.SynPullingDatapath"
            if direction == "Source":
                params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/SrcSynPullingController.py"
                params['RunParameters']['Datapath'] = "SDM.nodes.SrcSynPullingDatapath.SrcSynPullingDatapath"
    ...
    if state == "Pushing":
        ...
        if rate_type == "BW":
            params['RunParameters']['topoType'] = "SDM.topologies.TraceTopo.TraceTopo"
            params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/PushingController.py"
            params['RunParameters']['attack'] = "~/SDN-Monitoring/util/bw-attack"
            if direction == "Destination":
                params['RunParameters']['Datapath'] = "SDM.nodes.BWPushingDatapath.BWPushingDatapath"
                params['RunParameters']['middleware'] = "SDM.nodes.BWMiddleWare.BWMiddleWare"
            if direction == "Source":
        ...
        if rate_type == "Syn":
            params['RunParameters']['topoType'] = "SDM.topologies.SynTraceTopo.SynTraceTopo"
            params['RunParameters']['ryuApps'] = "~/SDN-Monitoring/SDM/apps/Pushing15Controller.py"
            params['RunParameters']['attack'] = "~/SDN-Monitoring/util/syn-attack"
            if direction == "Destination":
                params['RunParameters']['Datapath'] = "SDM.nodes.SynPushingDatapath.SynPushingDatapath"
                params['RunParameters']['middleware'] = "SDM.nodes.SynMiddleWare.SynMiddleWare"
            if direction == "Source":
                params['RunParameters']['Datapath'] = "SDM.nodes.SrcSynPushingDatapath.SrcSynPushingDatapath"
                params['RunParameters']['middleware'] = "SDM.nodes.SrcSynMiddleWare.SrcSynMiddleWare"
        if rate_type == "HH-several":
            if direction == "Destination":
                assert False
            f1 = ipv4_to_int
